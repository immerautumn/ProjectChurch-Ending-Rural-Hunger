...
if [[ $AWS_ACCESS_KEY && $AWS_SECRET_ACCESS_KEY && $AWS_DEFAULT_REGION ]]; then
    ...
    "EXPORT AWS_ACCESS_KEY='us-east-2'  # This can cahnge depending on where you are. West coast may opt for us-west-1 (California) or us-west-2 (Oregon), etc. For a full list of AWS" \
